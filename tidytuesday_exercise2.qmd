...
Does type of production affect number of eggs produced?
Outcome: number of eggs
Predictors: number of hens, production process
...
clean_egg$prod_process <- as.factor(clean_egg$prod_process)
clean_egg$prod_type <- as.factor(clean_egg$prod_type)

clean_egg$prod_process <- factor(clean_egg$prod_process, levels = c("cage-free (non-organic)", "cage-free (organic)", "all"), ordered = TRUE)
clean_egg$prod_type <- factor(clean_egg$prod_type, levels = c("hatching eggs", "table eggs"), ordered=TRUE)
#set seed
set.seed(123)
